...
{
	public int StrengthCost => (int)Math.Pow(Game.Player.Stats.Strength + 1, 2) * 10;

	public int WillpowerCost => (int)Math.Pow(Game.Player.Stats.Willpower + 1, 2) * 10;

	public int MemoryCost => (int)Math.Pow(Game.Player.Stats.Memory + 1, 2) * 10;
